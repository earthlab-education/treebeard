...
class Ui_treebeardDialogBase(object):
    def setupUi(self, treebeardDialogBase):
        ...
        self.processCanopyButton.setGeometry(QtCore.QRect(250, 150, 211, 31))
        ...
        self.reportSpataialButton.setGeometry(QtCore.QRect(110, 190, 261, 31))
        self.reportSpataialButton.setObjectName("reportSpataialButton")
        self.label_4 = QtWidgets.QLabel(treebeardDialogBase)
        self.label_4.setGeometry(QtCore.QRect(10, 110, 141, 21))
        self.label_4.setObjectName("label_4")
        self.outputLineEdit = QtWidgets.QLineEdit(treebeardDialogBase)
        self.outputLineEdit.setGeometry(QtCore.QRect(170, 110, 171, 21))
