...
class KMeansProcessor():
    # def generate_binary_gdf(self, tilepath, n_clusters=2):
    ...
    # def generate_binary_gdf_ndvi(self, tilepath, n_clusters=2, plot_segments=False, plot_path=None):
    #     # Load the image and bands
    #     tile = rasterio.open(tilepath)
    #     red = tile.read(1).astype(float)
    #     nir = tile.read(4).astype(float)
    ...
    def bin_plot(self, gdf, bins, labels, title, filepath=None, save_png_file=False):
